...
deactivate	\end{verbatim}
\end{itembox}

次の様に動作させる（入力が促されるので、日付を入力する）

\begin{screen}
\begin{verbatim}
	(venv11) mat$raspberrypi: ~/Documents $ sh daily0.sh
	Enter date string : YYYY-mm_dd
	2024-05-18
	(venv11) mat$raspberrypi: ~/Documents $
\end{verbatim}
\end{screen}
...
次の様に動作させる（入力が促されるので、1週間の最後の日付を入力する）

\begin{screen}
	\begin{verbatim}
		(venv11) mat$raspberrypi: ~/Documents $ sh weekly0.sh
		Enter last date string : YYYY-mm_dd
		2024-05-18
		(venv11) mat$raspberrypi: ~/Documents $
	\end{verbatim}
\end{screen}
